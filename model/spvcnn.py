...
from model.spvcnn_utils import *
from model.spvcnn_building_blocks import *
...
class SPVCNN(nn.Module):
    ...
    def __init__(self, in_channel, num_classes, config: dict):
        ...
        self.normalize_features = config.get('normalize_features')
        ...
        # self.classifier_vox = nn.Sequential(nn.Linear(cs[8], self.num_classes, bias=False))
    ...
    def forward(self, x):
        ...
        if self.normalize_features:
            return nn.functional.normalize(vox_out, p=2, dim=-1)
