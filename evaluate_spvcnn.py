...
def main():
    ...
    if args.cfg_file is None and args.dataset is not None:
        if args.dataset.lower() == "kitti":
            args.cfg_file = "config/semseg_kitti_spvcnn.yaml"
        elif args.dataset.lower() == "nuscenes":
            args.cfg_file = "config/semseg_nuscenes_spvcnn.yaml"
        elif args.dataset.lower() == 'waymo':
            args.cfg_file = "config/semseg_waymo_spvcnn.yaml"
        else:
    ...
    evaluate_spvcnn(model, val_dataloader, config)
